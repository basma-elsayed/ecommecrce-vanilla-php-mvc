...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="row">
                <div class="col-lg-4">
                    <h4 class="h4 font-weight-bold mb-3">Edit <?php $data['name']; ?></h4>
                </div>
            ...
            <form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- Category decription -->
                        <div class="form-group">
                            <label class="font-weight-semibold" for="cat_desc">Category Description</label>
                            <textarea 
                                class="form-control <?php echo error_class( $data, 'description_err' );?>" 
                                name="description" 
                                id="cat_desc" 
                                cols="10" 
                                rows="10"><?php echo GetInputValue( $data, 'description' ); ?></textarea>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="switch m-t-5 m-l-10">
                                        <input 
                                            ...
                                            type="checkbox" 
                                            id="cat_visbility" 
                                            <?php echo $data['visiblity'] ? "checked" : ""; ?> />
                                        <label for="cat_visbility"></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="switch m-t-5 m-l-10">
                                        <input 
                                            ...
                                            type="checkbox" 
                                            id="allow_comments" 
                                            <?php echo $data['allow_comments'] ? "checked" : ""; ?> />
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="switch m-t-5 m-l-10">
                                        <input
                                            ...
                                            type="checkbox" 
                                            id="allow_ads" 
                                            <?php echo $data['allow_ads'] ? "checked" : ""; ?> />
